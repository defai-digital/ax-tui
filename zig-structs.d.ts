...
declare const rgbaPackTransform: (rgba?: RGBA) => Pointer | null;
declare const rgbaUnpackTransform: (ptr?: Pointer) => RGBA | undefined;
...
export declare const StyledChunkStruct: import("bun-ffi-structs").DefineStructReturnType<[readonly ["text", "char*"], readonly ["text_len", "u64", {
    ...
    readonly packTransform: typeof rgbaPackTransform;
    readonly unpackTransform: typeof rgbaUnpackTransform;
}], readonly ["bg", "pointer", {
    readonly optional: true;
    readonly packTransform: typeof rgbaPackTransform;
    readonly unpackTransform: typeof rgbaUnpackTransform;
