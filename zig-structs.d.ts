...
export declare const VisualCursorStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["visualCol", "u32"],
    readonly ["logicalRow", "u32"],
    readonly ["logicalCol", "u32"],
    readonly ["offset", "u32"],
  ],
  {}
>
export declare const TerminalCapabilitiesStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["kitty_graphics", "bool_u8"],
    readonly ["rgb", "bool_u8"],
    readonly ["ansi256", "bool_u8"],
    readonly [
      "unicode",
      import("bun-ffi-structs").EnumDef<{
        wcwidth: number
        unicode: number
      }>,
    ],
    readonly ["sgr_pixels", "bool_u8"],
    readonly ["color_scheme_updates", "bool_u8"],
    readonly ["explicit_width", "bool_u8"],
    readonly ["scaled_text", "bool_u8"],
    readonly ["sixel", "bool_u8"],
    readonly ["focus_tracking", "bool_u8"],
    readonly ["sync", "bool_u8"],
    readonly ["bracketed_paste", "bool_u8"],
    readonly ["hyperlinks", "bool_u8"],
    readonly ["osc52", "bool_u8"],
    readonly ["notifications", "bool_u8"],
    readonly ["explicit_cursor_positioning", "bool_u8"],
    readonly ["remote", "bool_u8"],
    readonly [
      "multiplexer",
      import("bun-ffi-structs").EnumDef<{
        none: number
...
export declare const LineInfoStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["widthCols", readonly ["u32"]],
    readonly [
      "widthColsLen",
      "u32",
      {
...
export declare const CursorStateStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    readonly ["x", "u32"],
    readonly ["y", "u32"],
    readonly ["visible", "bool_u8"],
    readonly ["style", "u8"],
    readonly ["blinking", "bool_u8"],
    readonly ["r", "f32"],
    readonly ["g", "f32"],
    readonly ["b", "f32"],
    readonly ["a", "f32"],
...
export declare const AllocatorStatsStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["activeAllocations", "u64"],
    readonly ["smallAllocations", "u64"],
    readonly ["largeAllocations", "u64"],
    readonly ["requestedBytesValid", "bool_u8"],
  ],
  {}
>
...
export declare const NativeRenderStatsStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["averageFrameTime", "f64"],
    readonly ["renderTime", "f64"],
    readonly ["stdoutWriteTime", "f64"],
    readonly ["frameCount", "u64"],
    readonly ["cellsUpdated", "u32"],
    readonly ["averageCellsUpdated", "u32"],
    readonly ["renderTimeValid", "bool_u8"],
    readonly ["stdoutWriteTimeValid", "bool_u8"],
  ],
  {}
>
...
export declare const NativeSpanFeedStatsStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["spansCommitted", "u64"],
    readonly ["chunks", "u32"],
    readonly ["pendingSpans", "u32"],
  ],
  {}
>
export declare const SpanInfoStruct: import("bun-ffi-structs").DefineStructReturnType<
  ...
  {
    readonly reduceValue: (value: { chunkPtr: Pointer; offset: number; len: number; chunkIndex: number }) => {
      chunkPtr: Pointer
      offset: number
      len: number
      chunkIndex: number
...
export declare const ReserveInfoStruct: import("bun-ffi-structs").DefineStructReturnType<
  ...
  {
    readonly reduceValue: (value: { ptr: Pointer; len: number }) => {
      ptr: Pointer
      len: number
    }
  }
...
export declare const AudioStatsStruct: import("bun-ffi-structs").DefineStructReturnType<
  [
    ...
    readonly ["voicesActive", "u32"],
    readonly ["framesMixed", "u64"],
    readonly ["lockMisses", "u32"],
    readonly ["lastPeak", "f32"],
    readonly ["lastRms", "f32"],
  ],
  {}
>
export {}
