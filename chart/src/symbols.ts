...
export const BAR_LEVELS = ["▁", "▂", "▃", "▄", "▅", "▆", "▇", "█"] as const
...
export const BLOCK_EIGHTHS = ["▏", "▎", "▍", "▌", "▋", "▊", "▉", "█"] as const
 ...
 */
export function symbolForHeight(ticks: number): string {
  if (!(ticks > 0)) return BAR_EMPTY
  if (ticks >= 8) return BAR_LEVELS[7]!
