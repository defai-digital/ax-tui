...
// Keep pointer owners reachable until the synchronous native consumer returns.
const NODE_POINTER_PIN_SLOTS = 1024
const nodePointerPins: PointerSource[] = new Array(NODE_POINTER_PIN_SLOTS)
let nodePointerPinIndex = 0
function pinNodePointerSource(value: PointerSource): void {
