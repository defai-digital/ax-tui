...
export interface CliRendererConfig {
  /** Milliseconds to wait for an incomplete terminal escape sequence. Default 100. */
  stdinParserTimeoutMs?: number
...
//
// - "disabled": Hide the overlay. `AX_CODE_TUI_USE_CONSOLE` controls global console
//   capture.
...
export class CliRenderer extends EventEmitter implements RenderContext {
  ...
  private _debugModeEnabled: boolean = env.AX_CODE_TUI_DEBUG
